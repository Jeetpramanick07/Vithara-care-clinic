  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!contentType || !contentType.includes("application/json")) {
        ...
        console.log("Non-JSON response from API:", text);
  
        throw new Error(
          "API route is not returning JSON. Check route.js path, restart the server, and check terminal errors."
        );
      }
      ...
      setStatus({
        loading: false,
        success: result.message || "Appointment request submitted successfully.",
        error: "",
      });
