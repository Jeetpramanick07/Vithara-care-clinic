      ...
      <div className="footer-grid">
        ...
        <div className="footer-column">
          ...
          <ul>
            ...
            <li><a href="#services">Pediatric Care</a></li>
            <li><a href="#services">Preventive Checkups</a></li>
            <li><a href="#services">Family Healthcare</a></li>
        ...
        <div className="footer-column">
          ...
          <ul>
            ...
            <li><a href="#why">Why Choose Vithara</a></li>
        ...
        <div className="footer-column">
          ...
          <ul>
            ...
            <li><a href="#cta">Contact Clinic</a></li>
            <li><a href="#appointment">Patient Support</a></li>
